...
const (
	PennyDropHeaderHash       = "hash"
	PennyDropHeaderClientName = "clientName"

	SubmitBankDetailRoute                     = "submit"
	GetBankDetailRoute                        = "getDetails"
	lendingRoute                              = "lending"
	allowedBankChangeRoute                    = "allow_bankaccount_change"
	earlyPayoutRoute                          = "settlement/early/initiate"
